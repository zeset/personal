...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
     ...
     11b:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "iput test ok\n");
     ...
     181:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    printf(stdout, "mkdir failed\n");
     ...
     198:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(chdir("/") < 0){
    printf(stdout, "chdir / failed\n");
     ...
     1af:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(unlink("../iputdir") < 0){
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1c6:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(chdir("iputdir") < 0){
    printf(stdout, "chdir iputdir failed\n");
     ...
     1dd:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     1fb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     26d:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    ...
    if(unlink("../iputdir") < 0){
     ...
     288:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     ...
     29f:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    ...
    if(chdir("iputdir") < 0){
     ...
     2b6:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(pid == 0){
    if(mkdir("iputdir") < 0){
     ...
     2cd:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     2eb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     33a:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "openiput test ok\n");
     ...
     37a:	ff 35 f8 5c 00 00    	pushl  0x5cf8
     ...
     390:	e8 8d 34 00 00       	call   3822 <exit>
{
  ...
  if(mkdir("oidir") < 0){
    printf(stdout, "mkdir oidir failed\n");
     ...
     39c:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     ...
     3b3:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(unlink("oidir") != 0){
    printf(stdout, "unlink failed\n");
     ...
     3ca:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     3eb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "open test ok\n");
     ...
     431:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
     ...
     448:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     45f:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     47d:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd >= 0){
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4b0:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "writes ok\n");
     ...
     508:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     53e:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     572:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "small file test ok\n");
     ...
     5a0:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     5be:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     5d7:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     5ef:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     607:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     61f:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     637:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     65d:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "big files ok\n");
     ...
     755:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     773:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    ...
    if(((int*)buf)[0] != n){
     ...
     78a:	ff 35 f8 5c 00 00    	pushl  0x5cf8
     ...
     7a3:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     7c0:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
     ...
     7d8:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
     ...
     7f0:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     808:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     831:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8b6:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8db:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     941:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
     ...
     958:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
     ...
     96f:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
     ...
     986:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
     ...
     99d:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     9bb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
     9c1:	e8 ca 2f 00 00       	call   3990 <printf>
  if(exec("echo", echoargv) < 0){
     9c6:	5a                   	pop    %edx
     9c7:	59                   	pop    %ecx
     9c8:	68 fc 5c 00 00       	push   $0x5cfc
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     ...
     9e7:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a50:	57                   	push   %edi
     a51:	68 e0 84 00 00       	push   $0x84e0
     ...
     a6e:	f7 d9                	neg    %ecx
     a70:	38 9c 0b e0 84 00 00 	cmp    %bl,0x84e0(%ebx,%ecx,1)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a9a:	68 06 40 00 00       	push   $0x4006
     a9f:	6a 01                	push   $0x1
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     ad0:	88 9c 18 e0 84 00 00 	mov    %bl,0x84e0(%eax,%ebx,1)
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     ae8:	68 e0 84 00 00       	push   $0x84e0
  ...
  printf(1, "pipe1 ok\n");
     b25:	58                   	pop    %eax
     b26:	5a                   	pop    %edx
     b27:	68 2b 40 00 00       	push   $0x402b
     b2c:	6a 01                	push   $0x1
     b2e:	e8 5d 2e 00 00       	call   3990 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b41:	68 14 40 00 00       	push   $0x4014
     b46:	6a 01                	push   $0x1
     b48:	e8 43 2e 00 00       	call   3990 <printf>
      exit();
     b4d:	e8 d0 2c 00 00       	call   3822 <exit>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     ...
     b55:	68 e9 3f 00 00       	push   $0x3fe9
     b5a:	6a 01                	push   $0x1
     b5c:	e8 2f 2e 00 00       	call   3990 <printf>
    exit();
    ...
    printf(1, "fork() failed\n");
     ...
     b69:	68 35 40 00 00       	push   $0x4035
     b6e:	6a 01                	push   $0x1
     b70:	e8 1b 2e 00 00       	call   3990 <printf>
    exit();
    ...
    for(n = 0; n < 5; n++){
     ...
     b7d:	68 f8 3f 00 00       	push   $0x3ff8
     b82:	6a 01                	push   $0x1
     b84:	e8 07 2e 00 00       	call   3990 <printf>
        exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b99:	68 44 40 00 00       	push   $0x4044
     b9e:	6a 01                	push   $0x1
     ba0:	e8 eb 2d 00 00       	call   3990 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bea:	6a 01                	push   $0x1
     bec:	68 09 46 00 00       	push   $0x4609
     ...
     c04:	68 4e 40 00 00       	push   $0x404e
     c09:	6a 01                	push   $0x1
     c0b:	e8 80 2d 00 00       	call   3990 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c36:	68 e0 84 00 00       	push   $0x84e0
    ...
    printf(1, "preempt read error");
     ...
     c4e:	68 62 40 00 00       	push   $0x4062
     c53:	6a 01                	push   $0x1
     c55:	e8 36 2d 00 00       	call   3990 <printf>
    return;
  ...
  printf(1, "kill... ");
     c70:	58                   	pop    %eax
     c71:	5a                   	pop    %edx
     c72:	68 75 40 00 00       	push   $0x4075
     c77:	6a 01                	push   $0x1
     c79:	e8 12 2d 00 00       	call   3990 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c96:	59                   	pop    %ecx
     c97:	5b                   	pop    %ebx
     c98:	68 7e 40 00 00       	push   $0x407e
     c9d:	6a 01                	push   $0x1
     c9f:	e8 ec 2c 00 00       	call   3990 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     cb3:	5e                   	pop    %esi
     cb4:	5f                   	pop    %edi
     cb5:	68 87 40 00 00       	push   $0x4087
     cba:	6a 01                	push   $0x1
     cbc:	e8 cf 2c 00 00       	call   3990 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cfe:	68 f1 4b 00 00       	push   $0x4bf1
     d03:	6a 01                	push   $0x1
     d05:	e8 86 2c 00 00       	call   3990 <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     d1b:	68 93 40 00 00       	push   $0x4093
     d20:	6a 01                	push   $0x1
     d22:	e8 69 2c 00 00       	call   3990 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d3b:	68 a3 40 00 00       	push   $0x40a3
     d40:	6a 01                	push   $0x1
     d42:	e8 49 2c 00 00       	call   3990 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d69:	68 b0 40 00 00       	push   $0x40b0
     d6e:	6a 01                	push   $0x1
     d70:	e8 1b 2c 00 00       	call   3990 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d9c:	e8 1f 2e 00 00       	call   3bc0 <malloc>
    ...
    while(m1){
     ...
     db8:	e8 73 2d 00 00       	call   3b30 <free>
    m1 = 0;
    while((m2 = malloc(10001)) != 0){
      *(char**)m2 = m1;
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     dcc:	e8 ef 2d 00 00       	call   3bc0 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     ddb:	50                   	push   %eax
     ddc:	e8 4f 2d 00 00       	call   3b30 <free>
    printf(1, "mem ok\n");
     de1:	58                   	pop    %eax
     de2:	5a                   	pop    %edx
     de3:	68 d4 40 00 00       	push   $0x40d4
     de8:	6a 01                	push   $0x1
     dea:	e8 a1 2b 00 00       	call   3990 <printf>
    exit();
    ...
    if(m1 == 0){
     ...
     e0b:	68 ba 40 00 00       	push   $0x40ba
     e10:	6a 01                	push   $0x1
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e39:	68 dc 40 00 00       	push   $0x40dc
     e3e:	6a 01                	push   $0x1
     e40:	e8 4b 2b 00 00       	call   3990 <printf>

  unlink("sharedfd");
     e45:	c7 04 24 eb 40 00 00 	movl   $0x40eb,(%esp)
     e4c:	e8 21 2a 00 00       	call   3872 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e51:	5b                   	pop    %ebx
     e52:	5e                   	pop    %esi
     e53:	68 02 02 00 00       	push   $0x202
     e58:	68 eb 40 00 00       	push   $0x40eb
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ebc:	68 b8 4d 00 00       	push   $0x4db8
     ec1:	6a 01                	push   $0x1
     ec3:	e8 c8 2a 00 00       	call   3990 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     eea:	5a                   	pop    %edx
     eeb:	6a 00                	push   $0x0
     eed:	68 eb 40 00 00       	push   $0x40eb
  ...
  unlink("sharedfd");
     f5a:	c7 04 24 eb 40 00 00 	movl   $0x40eb,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f7f:	68 f4 40 00 00       	push   $0x40f4
     f84:	6a 01                	push   $0x1
     f86:	e8 05 2a 00 00       	call   3990 <printf>
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     f99:	68 8c 4d 00 00       	push   $0x4d8c
     f9e:	6a 01                	push   $0x1
     fa0:	e8 eb 29 00 00       	call   3990 <printf>
    return;
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fb3:	68 d8 4d 00 00       	push   $0x4dd8
     fb8:	6a 01                	push   $0x1
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fcf:	53                   	push   %ebx
     fd0:	52                   	push   %edx
     fd1:	68 01 41 00 00       	push   $0x4101
     fd6:	6a 01                	push   $0x1
     fd8:	e8 b3 29 00 00       	call   3990 <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ff6:	be 16 41 00 00       	mov    $0x4116,%esi
...
fourfiles(void)
{
  ...
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1000:	c7 45 d8 16 41 00 00 	movl   $0x4116,-0x28(%ebp)
    1007:	c7 45 dc 5f 42 00 00 	movl   $0x425f,-0x24(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    100e:	68 1c 41 00 00       	push   $0x411c
    1013:	6a 01                	push   $0x1
// time, to test block allocation.
void
fourfiles(void)
{
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1015:	c7 45 e0 63 42 00 00 	movl   $0x4263,-0x20(%ebp)
    101c:	c7 45 e4 19 41 00 00 	movl   $0x4119,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    1023:	e8 68 29 00 00       	call   3990 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1071:	c7 45 d4 16 41 00 00 	movl   $0x4116,-0x2c(%ebp)
  }
  ...
  for(i = 0; i < 2; i++){
    ...
    1098:	68 e0 84 00 00       	push   $0x84e0
    109d:	56                   	push   %esi
    ...
    10ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(j = 0; j < n; j++){
        if(buf[j] != '0'+i){
    10b0:	0f be 8a e0 84 00 00 	movsbl 0x84e0(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    10f7:	68 5a 41 00 00       	push   $0x415a
    10fc:	6a 01                	push   $0x1
    10fe:	e8 8d 28 00 00       	call   3990 <printf>
}
    ...
    111c:	68 3d 41 00 00       	push   $0x413d
    1121:	6a 01                	push   $0x1
    1123:	e8 68 28 00 00       	call   3990 <printf>
          exit();
    ...
    1155:	68 e0 84 00 00       	push   $0x84e0
    ...
    116a:	68 e0 84 00 00       	push   $0x84e0
    116f:	56                   	push   %esi
    ...
    118c:	50                   	push   %eax
    118d:	68 2c 41 00 00       	push   $0x412c
    1192:	6a 01                	push   $0x1
    1194:	e8 f7 27 00 00       	call   3990 <printf>
          exit();
    ...
    11a1:	68 b7 43 00 00       	push   $0x43b7
    11a6:	6a 01                	push   $0x1
    11a8:	e8 e3 27 00 00       	call   3990 <printf>
        exit();
    ...
    11b5:	53                   	push   %ebx
    11b6:	68 49 41 00 00       	push   $0x4149
    11bb:	6a 01                	push   $0x1
    11bd:	e8 ce 27 00 00       	call   3990 <printf>
      exit();
    ...
    11ca:	68 f1 4b 00 00       	push   $0x4bf1
    11cf:	6a 01                	push   $0x1
    11d1:	e8 ba 27 00 00       	call   3990 <printf>
      exit();
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    11eb:	68 68 41 00 00       	push   $0x4168
    11f0:	6a 01                	push   $0x1
    11f2:	e8 99 27 00 00       	call   3990 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    12ec:	68 7b 41 00 00       	push   $0x417b
    12f1:	6a 01                	push   $0x1
    12f3:	e8 98 26 00 00       	call   3990 <printf>
}
    ...
    1378:	68 69 3d 00 00       	push   $0x3d69
    137d:	6a 01                	push   $0x1
    137f:	e8 0c 26 00 00       	call   3990 <printf>
            exit();
    ...
    1398:	57                   	push   %edi
    1399:	68 04 4e 00 00       	push   $0x4e04
    139e:	6a 01                	push   $0x1
    13a0:	e8 eb 25 00 00       	call   3990 <printf>
        exit();
    ...
    13ad:	68 b7 43 00 00       	push   $0x43b7
    13b2:	6a 01                	push   $0x1
    13b4:	e8 d7 25 00 00       	call   3990 <printf>
          exit();
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    13c1:	68 f1 4b 00 00       	push   $0x4bf1
    13c6:	6a 01                	push   $0x1
    ...
    13dd:	57                   	push   %edi
    13de:	68 28 4e 00 00       	push   $0x4e28
    13e3:	6a 01                	push   $0x1
    13e5:	e8 a6 25 00 00       	call   3990 <printf>
        exit();
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    13f8:	68 8c 41 00 00       	push   $0x418c
    13fd:	6a 01                	push   $0x1
    13ff:	e8 8c 25 00 00       	call   3990 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1404:	5b                   	pop    %ebx
    1405:	5e                   	pop    %esi
    1406:	68 02 02 00 00       	push   $0x202
    140b:	68 9d 41 00 00       	push   $0x419d
  ...
  write(fd, "hello", 5);
    ...
    1425:	6a 05                	push   $0x5
    1427:	68 c2 41 00 00       	push   $0x41c2
    142c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    143b:	5a                   	pop    %edx
    143c:	6a 02                	push   $0x2
    143e:	68 9d 41 00 00       	push   $0x419d
  ...
  if(unlink("unlinkread") != 0){
    ...
    1458:	68 9d 41 00 00       	push   $0x419d
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1475:	68 9d 41 00 00       	push   $0x419d
  ...
  write(fd1, "yyy", 3);
    1484:	6a 03                	push   $0x3
    1486:	68 fa 41 00 00       	push   $0x41fa
    148b:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14a1:	68 e0 84 00 00       	push   $0x84e0
    14a6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14b8:	80 3d e0 84 00 00 68 	cmpb   $0x68,0x84e0
  ...
  if(write(fd, buf, 10) != 10){
    ...
    14c4:	6a 0a                	push   $0xa
    14c6:	68 e0 84 00 00       	push   $0x84e0
    14cb:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    14e2:	c7 04 24 9d 41 00 00 	movl   $0x419d,(%esp)
    14e9:	e8 84 23 00 00       	call   3872 <unlink>
  printf(1, "unlinkread ok\n");
    14ee:	58                   	pop    %eax
    14ef:	5a                   	pop    %edx
    14f0:	68 45 42 00 00       	push   $0x4245
    14f5:	6a 01                	push   $0x1
    14f7:	e8 94 24 00 00       	call   3990 <printf>
}
  ...
  if(fd < 0){
    ...
    1506:	51                   	push   %ecx
    1507:	51                   	push   %ecx
    1508:	68 a8 41 00 00       	push   $0x41a8
    150d:	6a 01                	push   $0x1
    150f:	e8 7c 24 00 00       	call   3990 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1519:	51                   	push   %ecx
    151a:	51                   	push   %ecx
    151b:	68 2c 42 00 00       	push   $0x422c
    1520:	6a 01                	push   $0x1
    1522:	e8 69 24 00 00       	call   3990 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    152c:	53                   	push   %ebx
    152d:	53                   	push   %ebx
    152e:	68 15 42 00 00       	push   $0x4215
    1533:	6a 01                	push   $0x1
    1535:	e8 56 24 00 00       	call   3990 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    153f:	56                   	push   %esi
    1540:	56                   	push   %esi
    1541:	68 fe 41 00 00       	push   $0x41fe
    1546:	6a 01                	push   $0x1
    1548:	e8 43 24 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("unlinkread") != 0){
    ...
    1552:	50                   	push   %eax
    1553:	50                   	push   %eax
    1554:	68 e0 41 00 00       	push   $0x41e0
    1559:	6a 01                	push   $0x1
    155b:	e8 30 24 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1565:	50                   	push   %eax
    1566:	50                   	push   %eax
    1567:	68 c8 41 00 00       	push   $0x41c8
    156c:	6a 01                	push   $0x1
    156e:	e8 1d 24 00 00       	call   3990 <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1587:	68 54 42 00 00       	push   $0x4254
    158c:	6a 01                	push   $0x1
    158e:	e8 fd 23 00 00       	call   3990 <printf>

  unlink("lf1");
    1593:	c7 04 24 5e 42 00 00 	movl   $0x425e,(%esp)
    159a:	e8 d3 22 00 00       	call   3872 <unlink>
  unlink("lf2");
    159f:	c7 04 24 62 42 00 00 	movl   $0x4262,(%esp)
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    15b2:	68 5e 42 00 00       	push   $0x425e
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15cc:	6a 05                	push   $0x5
    15ce:	68 c2 41 00 00       	push   $0x41c2
    15d3:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    15ee:	5b                   	pop    %ebx
    15ef:	58                   	pop    %eax
    15f0:	68 62 42 00 00       	push   $0x4262
    15f5:	68 5e 42 00 00       	push   $0x425e
  ...
  unlink("lf1");
    ...
    160d:	68 5e 42 00 00       	push   $0x425e
  ...
  if(open("lf1", 0) >= 0){
    ...
    1618:	5a                   	pop    %edx
    1619:	6a 00                	push   $0x0
    161b:	68 5e 42 00 00       	push   $0x425e
  ...
  fd = open("lf2", 0);
    ...
    1633:	6a 00                	push   $0x0
    1635:	68 62 42 00 00       	push   $0x4262
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1654:	68 e0 84 00 00       	push   $0x84e0
    1659:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1674:	58                   	pop    %eax
    1675:	5a                   	pop    %edx
    1676:	68 62 42 00 00       	push   $0x4262
    167b:	68 62 42 00 00       	push   $0x4262
  ...
  unlink("lf2");
    ...
    1693:	68 62 42 00 00       	push   $0x4262
    1698:	e8 d5 21 00 00       	call   3872 <unlink>
  if(link("lf2", "lf1") >= 0){
    169d:	59                   	pop    %ecx
    169e:	5b                   	pop    %ebx
    169f:	68 5e 42 00 00       	push   $0x425e
    16a4:	68 62 42 00 00       	push   $0x4262
  ...
  if(link(".", "lf1") >= 0){
    ...
    16b8:	68 5e 42 00 00       	push   $0x425e
    16bd:	68 26 45 00 00       	push   $0x4526
  ...
  printf(1, "linktest ok\n");
    ...
    16d1:	68 fc 42 00 00       	push   $0x42fc
    16d6:	6a 01                	push   $0x1
    16d8:	e8 b3 22 00 00       	call   3990 <printf>
}
  ...
  if(fd < 0){
    ...
    16e5:	50                   	push   %eax
    16e6:	50                   	push   %eax
    16e7:	68 66 42 00 00       	push   $0x4266
    16ec:	6a 01                	push   $0x1
    16ee:	e8 9d 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    ...
    16f8:	50                   	push   %eax
    16f9:	50                   	push   %eax
    16fa:	68 e0 42 00 00       	push   $0x42e0
    16ff:	6a 01                	push   $0x1
    1701:	e8 8a 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    170b:	52                   	push   %edx
    170c:	52                   	push   %edx
    170d:	68 70 4e 00 00       	push   $0x4e70
    1712:	6a 01                	push   $0x1
    1714:	e8 77 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    171e:	50                   	push   %eax
    171f:	50                   	push   %eax
    1720:	68 c2 42 00 00       	push   $0x42c2
    1725:	6a 01                	push   $0x1
    1727:	e8 64 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1731:	51                   	push   %ecx
    1732:	51                   	push   %ecx
    1733:	68 b1 42 00 00       	push   $0x42b1
    1738:	6a 01                	push   $0x1
    173a:	e8 51 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1744:	53                   	push   %ebx
    1745:	53                   	push   %ebx
    1746:	68 a0 42 00 00       	push   $0x42a0
    174b:	6a 01                	push   $0x1
    174d:	e8 3e 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    ...
    1757:	50                   	push   %eax
    1758:	50                   	push   %eax
    1759:	68 48 4e 00 00       	push   $0x4e48
    175e:	6a 01                	push   $0x1
    1760:	e8 2b 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    ...
    176a:	51                   	push   %ecx
    176b:	51                   	push   %ecx
    176c:	68 8b 42 00 00       	push   $0x428b
    1771:	6a 01                	push   $0x1
    1773:	e8 18 22 00 00       	call   3990 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    177d:	50                   	push   %eax
    177e:	50                   	push   %eax
    177f:	68 79 42 00 00       	push   $0x4279
    1784:	6a 01                	push   $0x1
    1786:	e8 05 22 00 00       	call   3990 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    17a3:	68 09 43 00 00       	push   $0x4309
    17a8:	6a 01                	push   $0x1
    17aa:	e8 e1 21 00 00       	call   3990 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1860:	53                   	push   %ebx
    1861:	68 1c 43 00 00       	push   $0x431c
    1866:	6a 01                	push   $0x1
    1868:	e8 23 21 00 00       	call   3990 <printf>
        exit();
    ...
    187b:	53                   	push   %ebx
    187c:	68 19 43 00 00       	push   $0x4319
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid && (i % 3) == 1){
      link("C0", file);
    1896:	53                   	push   %ebx
    1897:	68 19 43 00 00       	push   $0x4319
  ...
  fd = open(".", 0);
    ...
    18cc:	5e                   	pop    %esi
    18cd:	6a 00                	push   $0x0
    18cf:	68 26 45 00 00       	push   $0x4526
  ...
  printf(1, "concreate ok\n");
    ...
    1a23:	68 6e 43 00 00       	push   $0x436e
    1a28:	6a 01                	push   $0x1
    1a2a:	e8 61 1f 00 00       	call   3990 <printf>
}
  ...
  for(i = 0; i < 40; i++){
    ...
    1a3a:	68 f1 4b 00 00       	push   $0x4bf1
    1a3f:	6a 01                	push   $0x1
    1a41:	e8 4a 1f 00 00       	call   3990 <printf>
      exit();
  ...
  if(n != 40){
    ...
    1a4e:	68 94 4e 00 00       	push   $0x4e94
    1a53:	6a 01                	push   $0x1
    1a55:	e8 36 1f 00 00       	call   3990 <printf>
    exit();
    ...
    1a65:	50                   	push   %eax
    1a66:	68 51 43 00 00       	push   $0x4351
    1a6b:	6a 01                	push   $0x1
    1a6d:	e8 1e 1f 00 00       	call   3990 <printf>
        exit();
    ...
    1a7d:	50                   	push   %eax
    1a7e:	68 38 43 00 00       	push   $0x4338
    1a83:	6a 01                	push   $0x1
    1a85:	e8 06 1f 00 00       	call   3990 <printf>
        exit();
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1aa9:	68 7c 43 00 00       	push   $0x437c
    1aae:	6a 01                	push   $0x1
    1ab0:	e8 db 1e 00 00       	call   3990 <printf>

  unlink("x");
    1ab5:	c7 04 24 09 46 00 00 	movl   $0x4609,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1af8:	68 09 46 00 00       	push   $0x4609
  ...
  for(i = 0; i < 100; i++){
    ...
    1b2d:	68 09 46 00 00       	push   $0x4609
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b56:	68 91 43 00 00       	push   $0x4391
    1b5b:	6a 01                	push   $0x1
    1b5d:	e8 2e 1e 00 00       	call   3990 <printf>
}
  ...
  for(i = 0; i < 100; i++){
    ...
    1b73:	68 09 46 00 00       	push   $0x4609
    1b78:	68 8d 43 00 00       	push   $0x438d
  ...
  if(pid < 0){
    ...
    1b8d:	68 f1 4b 00 00       	push   $0x4bf1
    1b92:	6a 01                	push   $0x1
    1b94:	e8 f7 1d 00 00       	call   3990 <printf>
    exit();
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1bb8:	68 a0 43 00 00       	push   $0x43a0
    1bbd:	6a 01                	push   $0x1
    1bbf:	e8 cc 1d 00 00       	call   3990 <printf>
  unlink("bd");
    1bc4:	c7 04 24 ad 43 00 00 	movl   $0x43ad,(%esp)
  ...
  fd = open("bd", O_CREATE);
    ...
    1bd7:	68 ad 43 00 00       	push   $0x43ad
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
    1c0c:	56                   	push   %esi
    1c0d:	68 ad 43 00 00       	push   $0x43ad
  }
  close(fd);
  ...
  unlink("bd");
    1c43:	68 ad 43 00 00       	push   $0x43ad
  ...
  printf(1, "bigdir ok\n");
    ...
    1c8c:	68 ef 43 00 00       	push   $0x43ef
    1c91:	6a 01                	push   $0x1
    1c93:	e8 f8 1c 00 00       	call   3990 <printf>
}
    ...
    1ca5:	68 c6 43 00 00       	push   $0x43c6
    1caa:	6a 01                	push   $0x1
    1cac:	e8 df 1c 00 00       	call   3990 <printf>
      exit();
    ...
    1cb9:	68 da 43 00 00       	push   $0x43da
    1cbe:	6a 01                	push   $0x1
    1cc0:	e8 cb 1c 00 00       	call   3990 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    1ccd:	68 b0 43 00 00       	push   $0x43b0
    1cd2:	6a 01                	push   $0x1
    1cd4:	e8 b7 1c 00 00       	call   3990 <printf>
    exit();
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1ce7:	68 fa 43 00 00       	push   $0x43fa
    1cec:	6a 01                	push   $0x1
    1cee:	e8 9d 1c 00 00       	call   3990 <printf>

  unlink("ff");
    1cf3:	c7 04 24 83 44 00 00 	movl   $0x4483,(%esp)
    1cfa:	e8 73 1b 00 00       	call   3872 <unlink>
  if(mkdir("dd") != 0){
    1cff:	c7 04 24 20 45 00 00 	movl   $0x4520,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d1e:	68 59 44 00 00       	push   $0x4459
  ...
  write(fd, "ff", 2);
    ...
    1d38:	6a 02                	push   $0x2
    1d3a:	68 83 44 00 00       	push   $0x4483
    1d3f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d4d:	c7 04 24 20 45 00 00 	movl   $0x4520,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d67:	68 34 44 00 00       	push   $0x4434
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1d84:	68 56 44 00 00       	push   $0x4456
  ...
  write(fd, "FF", 2);
    ...
    1d9e:	6a 02                	push   $0x2
    1da0:	68 77 44 00 00       	push   $0x4477
    1da5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1db4:	5a                   	pop    %edx
    1db5:	6a 00                	push   $0x0
    1db7:	68 7a 44 00 00       	push   $0x447a
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1dd6:	68 e0 84 00 00       	push   $0x84e0
    1ddb:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1ded:	80 3d e0 84 00 00 66 	cmpb   $0x66,0x84e0
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e03:	5b                   	pop    %ebx
    1e04:	58                   	pop    %eax
    1e05:	68 ba 44 00 00       	push   $0x44ba
    1e0a:	68 56 44 00 00       	push   $0x4456
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e22:	68 56 44 00 00       	push   $0x4456
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e3a:	6a 00                	push   $0x0
    1e3c:	68 56 44 00 00       	push   $0x4456
  ...
  if(chdir("dd") != 0){
    ...
    1e54:	68 20 45 00 00       	push   $0x4520
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1e84:	68 14 45 00 00       	push   $0x4514
  ...
  if(chdir("./..") != 0){
    ...
    1e9c:	68 23 45 00 00       	push   $0x4523
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eb4:	6a 00                	push   $0x0
    1eb6:	68 ba 44 00 00       	push   $0x44ba
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ed5:	68 e0 84 00 00       	push   $0x84e0
    1eda:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1ef6:	5b                   	pop    %ebx
    1ef7:	6a 00                	push   $0x0
    1ef9:	68 56 44 00 00       	push   $0x4456
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f16:	68 6e 45 00 00       	push   $0x456e
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f33:	68 93 45 00 00       	push   $0x4593
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f50:	68 20 45 00 00       	push   $0x4520
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f68:	6a 02                	push   $0x2
    1f6a:	68 20 45 00 00       	push   $0x4520
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1f82:	6a 01                	push   $0x1
    1f84:	68 20 45 00 00       	push   $0x4520
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1f9c:	68 02 46 00 00       	push   $0x4602
    1fa1:	68 6e 45 00 00       	push   $0x456e
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fb9:	68 02 46 00 00       	push   $0x4602
    1fbe:	68 93 45 00 00       	push   $0x4593
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1fd6:	68 ba 44 00 00       	push   $0x44ba
    1fdb:	68 59 44 00 00       	push   $0x4459
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1ff3:	68 6e 45 00 00       	push   $0x456e
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    200b:	68 93 45 00 00       	push   $0x4593
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2023:	68 ba 44 00 00       	push   $0x44ba
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    203b:	68 93 45 00 00       	push   $0x4593
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2053:	68 6e 45 00 00       	push   $0x456e
  ...
  if(chdir("dd/ff") == 0){
    ...
    206b:	68 59 44 00 00       	push   $0x4459
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    209b:	68 ba 44 00 00       	push   $0x44ba
  ...
  if(unlink("dd/ff") != 0){
    ...
    20b3:	68 59 44 00 00       	push   $0x4459
  ...
  if(unlink("dd") == 0){
    ...
    20cb:	68 20 45 00 00       	push   $0x4520
  ...
  if(unlink("dd/dd") < 0){
    ...
    20e3:	68 35 44 00 00       	push   $0x4435
  ...
  if(unlink("dd") < 0){
    ...
    20fb:	68 20 45 00 00       	push   $0x4520
  ...
  printf(1, "subdir ok\n");
    ...
    2113:	68 02 47 00 00       	push   $0x4702
    2118:	6a 01                	push   $0x1
    211a:	e8 71 18 00 00       	call   3990 <printf>
}
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2127:	50                   	push   %eax
    2128:	50                   	push   %eax
    2129:	68 9f 44 00 00       	push   $0x449f
    212e:	6a 01                	push   $0x1
    2130:	e8 5b 18 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    213a:	50                   	push   %eax
    213b:	50                   	push   %eax
    213c:	68 fa 44 00 00       	push   $0x44fa
    2141:	6a 01                	push   $0x1
    2143:	e8 48 18 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    214d:	52                   	push   %edx
    214e:	52                   	push   %edx
    214f:	68 c5 44 00 00       	push   $0x44c5
    2154:	6a 01                	push   $0x1
    2156:	e8 35 18 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2160:	50                   	push   %eax
    2161:	50                   	push   %eax
    2162:	68 77 45 00 00       	push   $0x4577
    2167:	6a 01                	push   $0x1
    2169:	e8 22 18 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2173:	52                   	push   %edx
    2174:	52                   	push   %edx
    2175:	68 38 4f 00 00       	push   $0x4f38
    217a:	6a 01                	push   $0x1
    217c:	e8 0f 18 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2186:	52                   	push   %edx
    2187:	52                   	push   %edx
    2188:	68 0b 46 00 00       	push   $0x460b
    218d:	6a 01                	push   $0x1
    218f:	e8 fc 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2199:	51                   	push   %ecx
    219a:	51                   	push   %ecx
    219b:	68 a8 4f 00 00       	push   $0x4fa8
    21a0:	6a 01                	push   $0x1
    21a2:	e8 e9 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    21ac:	50                   	push   %eax
    21ad:	50                   	push   %eax
    21ae:	68 86 44 00 00       	push   $0x4486
    21b3:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    21bf:	51                   	push   %ecx
    21c0:	51                   	push   %ecx
    21c1:	68 5f 44 00 00       	push   $0x445f
    21c6:	6a 01                	push   $0x1
    21c8:	e8 c3 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    ...
    21d2:	50                   	push   %eax
    21d3:	50                   	push   %eax
    21d4:	68 28 45 00 00       	push   $0x4528
    21d9:	6a 01                	push   $0x1
    21db:	e8 b0 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    21e5:	51                   	push   %ecx
    21e6:	51                   	push   %ecx
    21e7:	68 f0 4e 00 00       	push   $0x4ef0
    21ec:	6a 01                	push   $0x1
    21ee:	e8 9d 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    21f8:	53                   	push   %ebx
    21f9:	53                   	push   %ebx
    21fa:	68 84 4f 00 00       	push   $0x4f84
    21ff:	6a 01                	push   $0x1
    2201:	e8 8a 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    220b:	50                   	push   %eax
    220c:	50                   	push   %eax
    220d:	68 60 4f 00 00       	push   $0x4f60
    2212:	6a 01                	push   $0x1
    2214:	e8 77 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    221e:	50                   	push   %eax
    221f:	50                   	push   %eax
    2220:	68 e7 45 00 00       	push   $0x45e7
    2225:	6a 01                	push   $0x1
    2227:	e8 64 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2231:	50                   	push   %eax
    2232:	50                   	push   %eax
    2233:	68 ce 45 00 00       	push   $0x45ce
    2238:	6a 01                	push   $0x1
    223a:	e8 51 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2244:	50                   	push   %eax
    2245:	50                   	push   %eax
    2246:	68 b8 45 00 00       	push   $0x45b8
    224b:	6a 01                	push   $0x1
    224d:	e8 3e 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2257:	50                   	push   %eax
    2258:	50                   	push   %eax
    2259:	68 9c 45 00 00       	push   $0x459c
    225e:	6a 01                	push   $0x1
    2260:	e8 2b 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    ...
    226a:	50                   	push   %eax
    226b:	50                   	push   %eax
    226c:	68 dd 44 00 00       	push   $0x44dd
    2271:	6a 01                	push   $0x1
    2273:	e8 18 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    227d:	50                   	push   %eax
    227e:	50                   	push   %eax
    227f:	68 14 4f 00 00       	push   $0x4f14
    2284:	6a 01                	push   $0x1
    2286:	e8 05 17 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2290:	53                   	push   %ebx
    2291:	53                   	push   %ebx
    2292:	68 3b 44 00 00       	push   $0x443b
    2297:	6a 01                	push   $0x1
    2299:	e8 f2 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    ...
    22a3:	50                   	push   %eax
    22a4:	50                   	push   %eax
    22a5:	68 c8 4e 00 00       	push   $0x4ec8
    22aa:	6a 01                	push   $0x1
    22ac:	e8 df 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    22b6:	50                   	push   %eax
    22b7:	50                   	push   %eax
    22b8:	68 1f 44 00 00       	push   $0x441f
    22bd:	6a 01                	push   $0x1
    22bf:	e8 cc 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("dd") != 0){
    ...
    22c9:	50                   	push   %eax
    22ca:	50                   	push   %eax
    22cb:	68 07 44 00 00       	push   $0x4407
    22d0:	6a 01                	push   $0x1
    22d2:	e8 b9 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    ...
    22dc:	50                   	push   %eax
    22dd:	50                   	push   %eax
    22de:	68 f0 46 00 00       	push   $0x46f0
    22e3:	6a 01                	push   $0x1
    22e5:	e8 a6 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    ...
    22ef:	52                   	push   %edx
    22f0:	52                   	push   %edx
    22f1:	68 db 46 00 00       	push   $0x46db
    22f6:	6a 01                	push   $0x1
    22f8:	e8 93 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    ...
    2302:	51                   	push   %ecx
    2303:	51                   	push   %ecx
    2304:	68 cc 4f 00 00       	push   $0x4fcc
    2309:	6a 01                	push   $0x1
    230b:	e8 80 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    ...
    2315:	53                   	push   %ebx
    2316:	53                   	push   %ebx
    2317:	68 c6 46 00 00       	push   $0x46c6
    231c:	6a 01                	push   $0x1
    231e:	e8 6d 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    ...
    2328:	50                   	push   %eax
    2329:	50                   	push   %eax
    232a:	68 ae 46 00 00       	push   $0x46ae
    232f:	6a 01                	push   $0x1
    2331:	e8 5a 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    ...
    233b:	50                   	push   %eax
    233c:	50                   	push   %eax
    233d:	68 96 46 00 00       	push   $0x4696
    2342:	6a 01                	push   $0x1
    2344:	e8 47 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    234e:	50                   	push   %eax
    234f:	50                   	push   %eax
    2350:	68 7a 46 00 00       	push   $0x467a
    2355:	6a 01                	push   $0x1
    2357:	e8 34 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2361:	50                   	push   %eax
    2362:	50                   	push   %eax
    2363:	68 5e 46 00 00       	push   $0x465e
    2368:	6a 01                	push   $0x1
    236a:	e8 21 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2374:	50                   	push   %eax
    2375:	50                   	push   %eax
    2376:	68 41 46 00 00       	push   $0x4641
    237b:	6a 01                	push   $0x1
    237d:	e8 0e 16 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2387:	50                   	push   %eax
    2388:	50                   	push   %eax
    2389:	68 26 46 00 00       	push   $0x4626
    238e:	6a 01                	push   $0x1
    2390:	e8 fb 15 00 00       	call   3990 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    239a:	50                   	push   %eax
    239b:	50                   	push   %eax
    239c:	68 53 45 00 00       	push   $0x4553
    23a1:	6a 01                	push   $0x1
    23a3:	e8 e8 15 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    23ad:	50                   	push   %eax
    23ae:	50                   	push   %eax
    23af:	68 3b 45 00 00       	push   $0x453b
    23b4:	6a 01                	push   $0x1
    23b6:	e8 d5 15 00 00       	call   3990 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23cd:	68 0d 47 00 00       	push   $0x470d
    23d2:	6a 01                	push   $0x1
    23d4:	e8 b7 15 00 00       	call   3990 <printf>

  unlink("bigwrite");
    23d9:	c7 04 24 1c 47 00 00 	movl   $0x471c,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    23f8:	68 1c 47 00 00       	push   $0x471c
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    240e:	53                   	push   %ebx
    240f:	68 e0 84 00 00       	push   $0x84e0
    2414:	50                   	push   %eax
    ...
    2424:	53                   	push   %ebx
    2425:	68 e0 84 00 00       	push   $0x84e0
    242a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2446:	c7 04 24 1c 47 00 00 	movl   $0x471c,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2460:	68 4f 47 00 00       	push   $0x474f
    2465:	6a 01                	push   $0x1
    2467:	e8 24 15 00 00       	call   3990 <printf>
}
    ...
    2476:	50                   	push   %eax
    2477:	53                   	push   %ebx
    2478:	68 3d 47 00 00       	push   $0x473d
    247d:	6a 01                	push   $0x1
    247f:	e8 0c 15 00 00       	call   3990 <printf>
        exit();
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    248c:	68 25 47 00 00       	push   $0x4725
    2491:	6a 01                	push   $0x1
    2493:	e8 f8 14 00 00       	call   3990 <printf>
      exit();
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    24a9:	68 5c 47 00 00       	push   $0x475c
    24ae:	6a 01                	push   $0x1
    24b0:	e8 db 14 00 00       	call   3990 <printf>

  unlink("bigfile");
    24b5:	c7 04 24 78 47 00 00 	movl   $0x4778,(%esp)
    24bc:	e8 b1 13 00 00       	call   3872 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24c1:	5e                   	pop    %esi
    24c2:	5f                   	pop    %edi
    24c3:	68 02 02 00 00       	push   $0x202
    24c8:	68 78 47 00 00       	push   $0x4778
  ...
  fd = open("bigfile", 0);
    ...
    252e:	5b                   	pop    %ebx
    252f:	6a 00                	push   $0x0
    2531:	68 78 47 00 00       	push   $0x4778
  ...
  if(fd < 0){
    ...
    255b:	0f be 05 e0 84 00 00 	movsbl 0x84e0,%eax
    2562:	89 fa                	mov    %edi,%edx
    2564:	d1 fa                	sar    %edx
    2566:	39 d0                	cmp    %edx,%eax
    2568:	75 6e                	jne    25d8 <bigfile+0x138>
    256a:	0f be 15 0b 86 00 00 	movsbl 0x860b,%edx
  ...
  for(i = 0; ; i++){
    ...
    2586:	68 e0 84 00 00       	push   $0x84e0
    258b:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25b5:	68 78 47 00 00       	push   $0x4778
    25ba:	e8 b3 12 00 00       	call   3872 <unlink>

  printf(1, "bigfile test ok\n");
    25bf:	58                   	pop    %eax
    25c0:	5a                   	pop    %edx
    25c1:	68 07 48 00 00       	push   $0x4807
    25c6:	6a 01                	push   $0x1
    25c8:	e8 c3 13 00 00       	call   3990 <printf>
}
    ...
    25db:	68 d4 47 00 00       	push   $0x47d4
    25e0:	6a 01                	push   $0x1
    25e2:	e8 a9 13 00 00       	call   3990 <printf>
      exit();
    ...
    25ef:	68 c0 47 00 00       	push   $0x47c0
    25f4:	6a 01                	push   $0x1
    25f6:	e8 95 13 00 00       	call   3990 <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    2603:	68 ab 47 00 00       	push   $0x47ab
    2608:	6a 01                	push   $0x1
    260a:	e8 81 13 00 00       	call   3990 <printf>
      exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2617:	68 80 47 00 00       	push   $0x4780
    261c:	6a 01                	push   $0x1
    261e:	e8 6d 13 00 00       	call   3990 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    262b:	68 96 47 00 00       	push   $0x4796
    2630:	6a 01                	push   $0x1
    2632:	e8 59 13 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    263f:	68 6a 47 00 00       	push   $0x476a
    2644:	6a 01                	push   $0x1
    2646:	e8 45 13 00 00       	call   3990 <printf>
    exit();
  ...
  if(total != 20*600){
    ...
    2653:	68 ed 47 00 00       	push   $0x47ed
    2658:	6a 01                	push   $0x1
    265a:	e8 31 13 00 00       	call   3990 <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2676:	68 18 48 00 00       	push   $0x4818
    267b:	6a 01                	push   $0x1
    267d:	e8 0e 13 00 00       	call   3990 <printf>

  if(mkdir("12345678901234") != 0){
    2682:	c7 04 24 53 48 00 00 	movl   $0x4853,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    269c:	68 ec 4f 00 00       	push   $0x4fec
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26b9:	68 3c 50 00 00       	push   $0x503c
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26d8:	5a                   	pop    %edx
    26d9:	6a 00                	push   $0x0
    26db:	68 ac 50 00 00       	push   $0x50ac
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    26f5:	c7 04 24 44 48 00 00 	movl   $0x4844,(%esp)
  ...
  printf(1, "fourteen ok\n");
    ...
    271f:	68 62 48 00 00       	push   $0x4862
    2724:	6a 01                	push   $0x1
    2726:	e8 65 12 00 00       	call   3990 <printf>
}
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2730:	50                   	push   %eax
    2731:	50                   	push   %eax
    2732:	68 27 48 00 00       	push   $0x4827
    2737:	6a 01                	push   $0x1
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2743:	50                   	push   %eax
    2744:	50                   	push   %eax
    2745:	68 68 51 00 00       	push   $0x5168
    274a:	6a 01                	push   $0x1
    274c:	e8 3f 12 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2756:	52                   	push   %edx
    2757:	52                   	push   %edx
    2758:	68 18 51 00 00       	push   $0x5118
    275d:	6a 01                	push   $0x1
    275f:	e8 2c 12 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2769:	51                   	push   %ecx
    276a:	51                   	push   %ecx
    276b:	68 dc 50 00 00       	push   $0x50dc
    2770:	6a 01                	push   $0x1
    2772:	e8 19 12 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    277c:	51                   	push   %ecx
    277d:	51                   	push   %ecx
    277e:	68 6c 50 00 00       	push   $0x506c
    2783:	6a 01                	push   $0x1
    2785:	e8 06 12 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    278f:	50                   	push   %eax
    2790:	50                   	push   %eax
    2791:	68 0c 50 00 00       	push   $0x500c
    2796:	6a 01                	push   $0x1
    2798:	e8 f3 11 00 00       	call   3990 <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    27b6:	68 6f 48 00 00       	push   $0x486f
    27bb:	6a 01                	push   $0x1
    27bd:	e8 ce 11 00 00       	call   3990 <printf>
  if(mkdir("dots") != 0){
    27c2:	c7 04 24 7b 48 00 00 	movl   $0x487b,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27dc:	68 7b 48 00 00       	push   $0x487b
  ...
  if(unlink(".") == 0){
    ...
    27f4:	68 26 45 00 00       	push   $0x4526
  ...
  if(unlink("..") == 0){
    ...
    280c:	68 25 45 00 00       	push   $0x4525
  ...
  if(chdir("/") != 0){
    ...
    2824:	68 f9 3c 00 00       	push   $0x3cf9
  ...
  if(unlink("dots/.") == 0){
    ...
    283c:	68 c3 48 00 00       	push   $0x48c3
  ...
  if(unlink("dots/..") == 0){
    ...
    2850:	68 e1 48 00 00       	push   $0x48e1
  ...
  if(unlink("dots") != 0){
    ...
    2864:	68 7b 48 00 00       	push   $0x487b
  ...
  printf(1, "rmdot ok\n");
    ...
    2878:	68 16 49 00 00       	push   $0x4916
    287d:	6a 01                	push   $0x1
    287f:	e8 0c 11 00 00       	call   3990 <printf>
}
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2889:	50                   	push   %eax
    288a:	50                   	push   %eax
    288b:	68 80 48 00 00       	push   $0x4880
    2890:	6a 01                	push   $0x1
    2892:	e8 f9 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dots") != 0){
    ...
    289c:	50                   	push   %eax
    289d:	50                   	push   %eax
    289e:	68 01 49 00 00       	push   $0x4901
    28a3:	6a 01                	push   $0x1
    28a5:	e8 e6 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dots/..") == 0){
    ...
    28af:	52                   	push   %edx
    28b0:	52                   	push   %edx
    28b1:	68 e9 48 00 00       	push   $0x48e9
    28b6:	6a 01                	push   $0x1
    28b8:	e8 d3 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dots/.") == 0){
    ...
    28c2:	51                   	push   %ecx
    28c3:	51                   	push   %ecx
    28c4:	68 ca 48 00 00       	push   $0x48ca
    28c9:	6a 01                	push   $0x1
    28cb:	e8 c0 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("/") != 0){
    ...
    28d5:	50                   	push   %eax
    28d6:	50                   	push   %eax
    28d7:	68 fb 3c 00 00       	push   $0x3cfb
    28dc:	6a 01                	push   $0x1
    28de:	e8 ad 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("..") == 0){
    ...
    28e8:	50                   	push   %eax
    28e9:	50                   	push   %eax
    28ea:	68 b4 48 00 00       	push   $0x48b4
    28ef:	6a 01                	push   $0x1
    28f1:	e8 9a 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink(".") == 0){
    ...
    28fb:	50                   	push   %eax
    28fc:	50                   	push   %eax
    28fd:	68 a6 48 00 00       	push   $0x48a6
    2902:	6a 01                	push   $0x1
    2904:	e8 87 10 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("dots") != 0){
    ...
    290e:	50                   	push   %eax
    290f:	50                   	push   %eax
    2910:	68 93 48 00 00       	push   $0x4893
    2915:	6a 01                	push   $0x1
    2917:	e8 74 10 00 00       	call   3990 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2937:	68 20 49 00 00       	push   $0x4920
    293c:	6a 01                	push   $0x1
    293e:	e8 4d 10 00 00       	call   3990 <printf>

  fd = open("dirfile", O_CREATE);
    2943:	59                   	pop    %ecx
    2944:	5b                   	pop    %ebx
    2945:	68 00 02 00 00       	push   $0x200
    294a:	68 2d 49 00 00       	push   $0x492d
  ...
  if(chdir("dirfile") == 0){
    2968:	c7 04 24 2d 49 00 00 	movl   $0x492d,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2982:	6a 00                	push   $0x0
    2984:	68 66 49 00 00       	push   $0x4966
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29a1:	68 66 49 00 00       	push   $0x4966
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29b9:	68 66 49 00 00       	push   $0x4966
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29d1:	68 66 49 00 00       	push   $0x4966
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    29e9:	68 66 49 00 00       	push   $0x4966
    29ee:	68 ca 49 00 00       	push   $0x49ca
  ...
  if(unlink("dirfile") != 0){
    ...
    2a06:	68 2d 49 00 00       	push   $0x492d
  ...
  fd = open(".", O_RDWR);
    ...
    2a1e:	6a 02                	push   $0x2
    2a20:	68 26 45 00 00       	push   $0x4526
  ...
  fd = open(".", 0);
    ...
    2a38:	6a 00                	push   $0x0
    2a3a:	68 26 45 00 00       	push   $0x4526
  ...
  if(write(fd, "x", 1) > 0){
    2a49:	6a 01                	push   $0x1
    2a4b:	68 09 46 00 00       	push   $0x4609
    2a50:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a66:	58                   	pop    %eax
    2a67:	5a                   	pop    %edx
    2a68:	68 fd 49 00 00       	push   $0x49fd
    2a6d:	6a 01                	push   $0x1
    2a6f:	e8 1c 0f 00 00       	call   3990 <printf>
}
  ...
  if(fd >= 0){
    ...
    2a7c:	50                   	push   %eax
    2a7d:	50                   	push   %eax
    2a7e:	68 71 49 00 00       	push   $0x4971
    2a83:	6a 01                	push   $0x1
    2a85:	e8 06 0f 00 00       	call   3990 <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    2a8f:	50                   	push   %eax
    2a90:	50                   	push   %eax
    2a91:	68 4c 49 00 00       	push   $0x494c
    2a96:	6a 01                	push   $0x1
    2a98:	e8 f3 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2aa2:	52                   	push   %edx
    2aa3:	52                   	push   %edx
    2aa4:	68 35 49 00 00       	push   $0x4935
    2aa9:	6a 01                	push   $0x1
    2aab:	e8 e0 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ab5:	51                   	push   %ecx
    2ab6:	51                   	push   %ecx
    2ab7:	68 e9 49 00 00       	push   $0x49e9
    2abc:	6a 01                	push   $0x1
    2abe:	e8 cd 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2ac8:	53                   	push   %ebx
    2ac9:	53                   	push   %ebx
    2aca:	68 bc 51 00 00       	push   $0x51bc
    2acf:	6a 01                	push   $0x1
    2ad1:	e8 ba 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dirfile") != 0){
    ...
    2adb:	50                   	push   %eax
    2adc:	50                   	push   %eax
    2add:	68 d1 49 00 00       	push   $0x49d1
    2ae2:	6a 01                	push   $0x1
    2ae4:	e8 a7 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2aee:	50                   	push   %eax
    2aef:	50                   	push   %eax
    2af0:	68 9c 51 00 00       	push   $0x519c
    2af5:	6a 01                	push   $0x1
    2af7:	e8 94 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2b01:	50                   	push   %eax
    2b02:	50                   	push   %eax
    2b03:	68 ac 49 00 00       	push   $0x49ac
    2b08:	6a 01                	push   $0x1
    2b0a:	e8 81 0e 00 00       	call   3990 <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2b14:	50                   	push   %eax
    2b15:	50                   	push   %eax
    2b16:	68 8f 49 00 00       	push   $0x498f
    2b1b:	6a 01                	push   $0x1
    2b1d:	e8 6e 0e 00 00       	call   3990 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2b3c:	68 0d 4a 00 00       	push   $0x4a0d
    2b41:	6a 01                	push   $0x1
    2b43:	e8 48 0e 00 00       	call   3990 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2b53:	68 1e 4a 00 00       	push   $0x4a1e
    ...
    2b6b:	68 1e 4a 00 00       	push   $0x4a1e
    ...
    2b83:	68 d3 40 00 00       	push   $0x40d3
    2b88:	e8 fd 0c 00 00       	call   388a <mkdir>
    link("README", "");
    2b8d:	59                   	pop    %ecx
    2b8e:	58                   	pop    %eax
    2b8f:	68 d3 40 00 00       	push   $0x40d3
    2b94:	68 ca 49 00 00       	push   $0x49ca
    2b99:	e8 e4 0c 00 00       	call   3882 <link>
    fd = open("", O_CREATE);
    2b9e:	58                   	pop    %eax
    2b9f:	5a                   	pop    %edx
    2ba0:	68 00 02 00 00       	push   $0x200
    2ba5:	68 d3 40 00 00       	push   $0x40d3
    ...
    2bca:	68 08 46 00 00       	push   $0x4608
    ...
    2bea:	68 08 46 00 00       	push   $0x4608
  ...
  chdir("/");
    ...
    2c03:	68 f9 3c 00 00       	push   $0x3cf9
    2c08:	e8 85 0c 00 00       	call   3892 <chdir>
  printf(1, "empty file name OK\n");
    2c0d:	58                   	pop    %eax
    2c0e:	5a                   	pop    %edx
    2c0f:	68 4c 4a 00 00       	push   $0x4a4c
    2c14:	6a 01                	push   $0x1
    2c16:	e8 75 0d 00 00       	call   3990 <printf>
}
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c26:	68 24 4a 00 00       	push   $0x4a24
    2c2b:	6a 01                	push   $0x1
    2c2d:	e8 5e 0d 00 00       	call   3990 <printf>
      exit();
    ...
    2c3a:	68 38 4a 00 00       	push   $0x4a38
    2c3f:	6a 01                	push   $0x1
    2c41:	e8 4a 0d 00 00       	call   3990 <printf>
      exit();
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2c59:	68 60 4a 00 00       	push   $0x4a60
    2c5e:	6a 01                	push   $0x1
    2c60:	e8 2b 0d 00 00       	call   3990 <printf>
    ...
    2c70:	74 62                	je     2cd4 <forktest+0x84>
{
  ...
  printf(1, "fork test OK\n");
    ...
    2cab:	68 92 4a 00 00       	push   $0x4a92
    2cb0:	6a 01                	push   $0x1
    2cb2:	e8 d9 0c 00 00       	call   3990 <printf>
}
  ...
  if(n == 1000){
    ...
    2cc3:	68 dc 51 00 00       	push   $0x51dc
    2cc8:	6a 01                	push   $0x1
    2cca:	e8 c1 0c 00 00       	call   3990 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2cdc:	68 6b 4a 00 00       	push   $0x4a6b
    2ce1:	6a 01                	push   $0x1
    2ce3:	e8 a8 0c 00 00       	call   3990 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2cf0:	68 7f 4a 00 00       	push   $0x4a7f
    2cf5:	6a 01                	push   $0x1
    2cf7:	e8 94 0c 00 00       	call   3990 <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2d1b:	68 a0 4a 00 00       	push   $0x4aa0
    2d20:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    2d26:	e8 65 0c 00 00       	call   3990 <printf>
  oldbrk = sbrk(0);
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f8c:	68 48 4b 00 00       	push   $0x4b48
    2f91:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    2f97:	e8 f4 09 00 00       	call   3990 <printf>
}
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2fc0:	6a 01                	push   $0x1
    2fc2:	68 09 46 00 00       	push   $0x4609
  ...
  for(i = 0; i < 5000; i++){
    ...
    2fee:	53                   	push   %ebx
    2fef:	57                   	push   %edi
    2ff0:	68 ab 4a 00 00       	push   $0x4aab
    2ff5:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    2ffb:	e8 90 09 00 00       	call   3990 <printf>
      exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    300b:	68 2d 4b 00 00       	push   $0x4b2d
    3010:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3016:	e8 75 09 00 00       	call   3990 <printf>
    exit();
  ...
  if(pipe(fds) != 0){
    ...
    3023:	68 e9 3f 00 00       	push   $0x3fe9
    3028:	6a 01                	push   $0x1
    302a:	e8 61 09 00 00       	call   3990 <printf>
    exit();
    ...
    3037:	50                   	push   %eax
    3038:	53                   	push   %ebx
    3039:	68 14 4b 00 00       	push   $0x4b14
    303e:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3044:	e8 47 09 00 00       	call   3990 <printf>
      kill(ppid);
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3059:	68 f1 4b 00 00       	push   $0x4bf1
    305e:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3064:	e8 27 09 00 00       	call   3990 <printf>
      exit();
  ...
  if(c != a){
    ...
    306e:	50                   	push   %eax
    306f:	53                   	push   %ebx
    3070:	68 d0 52 00 00       	push   $0x52d0
    3075:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    307b:	e8 10 09 00 00       	call   3990 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3088:	68 a0 52 00 00       	push   $0x52a0
    308d:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3093:	e8 f8 08 00 00       	call   3990 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    309d:	57                   	push   %edi
    309e:	53                   	push   %ebx
    309f:	68 78 52 00 00       	push   $0x5278
    30a4:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    30aa:	e8 e1 08 00 00       	call   3990 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    30b4:	50                   	push   %eax
    30b5:	53                   	push   %ebx
    30b6:	68 40 52 00 00       	push   $0x5240
    30bb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    30c1:	e8 ca 08 00 00       	call   3990 <printf>
    exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    30ce:	68 f9 4a 00 00       	push   $0x4af9
    30d3:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    30d9:	e8 b2 08 00 00       	call   3990 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    30e6:	68 00 52 00 00       	push   $0x5200
    30eb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    30f1:	e8 9a 08 00 00       	call   3990 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3103:	68 dd 4a 00 00       	push   $0x4add
    3108:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    310e:	e8 7d 08 00 00       	call   3990 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    311b:	68 c6 4a 00 00       	push   $0x4ac6
    3120:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    314a:	68 56 4b 00 00       	push   $0x4b56
    314f:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    318f:	5a                   	pop    %edx
    3190:	53                   	push   %ebx
    3191:	68 65 4b 00 00       	push   $0x4b65
  ...
  printf(stdout, "validate ok\n");
    ...
    31b4:	68 89 4b 00 00       	push   $0x4b89
    31b9:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    31d6:	68 70 4b 00 00       	push   $0x4b70
    31db:	ff 35 f8 5c 00 00    	pushl  0x5cf8
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    31f6:	68 96 4b 00 00       	push   $0x4b96
    31fb:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3201:	e8 8a 07 00 00       	call   3990 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
    3206:	83 c4 10             	add    $0x10,%esp
    3209:	80 3d c0 5d 00 00 00 	cmpb   $0x0,0x5dc0
    3210:	75 35                	jne    3247 <bsstest+0x57>
    3212:	b8 c1 5d 00 00       	mov    $0x5dc1,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
  for(i = 0; i < sizeof(uninit); i++){
    3228:	3d d0 84 00 00       	cmp    $0x84d0,%eax
  ...
  printf(stdout, "bss test ok\n");
    ...
    3232:	68 b1 4b 00 00       	push   $0x4bb1
    3237:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    323d:	e8 4e 07 00 00       	call   3990 <printf>
}
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    324a:	68 a0 4b 00 00       	push   $0x4ba0
    324f:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3255:	e8 36 07 00 00       	call   3990 <printf>
      exit();
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3266:	68 be 4b 00 00       	push   $0x4bbe
  ...
  fd = open("bigarg-ok", 0);
    ...
    328a:	6a 00                	push   $0x0
    328c:	68 be 4b 00 00       	push   $0x4bbe
  ...
  unlink("bigarg-ok");
    32aa:	c7 04 24 be 4b 00 00 	movl   $0x4bbe,(%esp)
    32b1:	e8 bc 05 00 00       	call   3872 <unlink>
}
    32b6:	83 c4 10             	add    $0x10,%esp
    32b9:	c9                   	leave  
    32ba:	c3                   	ret    
    32bb:	b8 20 5d 00 00       	mov    $0x5d20,%eax
  pid = fork();
  if(pid == 0){
    ...
    32c0:	c7 00 f4 52 00 00    	movl   $0x52f4,(%eax)
  ...
  if(pid == 0){
    ...
    int i;
    for(i = 0; i < MAXARG-1; i++)
    32c9:	3d 9c 5d 00 00       	cmp    $0x5d9c,%eax
    ...
    32d0:	51                   	push   %ecx
    32d1:	51                   	push   %ecx
    32d2:	68 c8 4b 00 00       	push   $0x4bc8
    32d7:	ff 35 f8 5c 00 00    	pushl  0x5cf8
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    for(i = 0; i < MAXARG-1; i++)
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    32dd:	c7 05 9c 5d 00 00 00 	movl   $0x0,0x5d9c
    32e4:	00 00 00 
    printf(stdout, "bigarg test\n");
    32e7:	e8 a4 06 00 00       	call   3990 <printf>
    exec("echo", args);
    32ec:	58                   	pop    %eax
    32ed:	5a                   	pop    %edx
    32ee:	68 20 5d 00 00       	push   $0x5d20
    32f3:	68 95 3d 00 00       	push   $0x3d95
    32f8:	e8 5d 05 00 00       	call   385a <exec>
    printf(stdout, "bigarg test ok\n");
    32fd:	59                   	pop    %ecx
    32fe:	58                   	pop    %eax
    32ff:	68 d5 4b 00 00       	push   $0x4bd5
    3304:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    330a:	e8 81 06 00 00       	call   3990 <printf>
    fd = open("bigarg-ok", O_CREATE);
    330f:	58                   	pop    %eax
    3310:	5a                   	pop    %edx
    3311:	68 00 02 00 00       	push   $0x200
    3316:	68 be 4b 00 00       	push   $0x4bbe
  ...
  if(fd < 0){
    ...
    332d:	50                   	push   %eax
    332e:	50                   	push   %eax
    332f:	68 fe 4b 00 00       	push   $0x4bfe
    3334:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    333a:	e8 51 06 00 00       	call   3990 <printf>
    exit();
    ...
    3344:	52                   	push   %edx
    3345:	52                   	push   %edx
    3346:	68 e5 4b 00 00       	push   $0x4be5
    334b:	ff 35 f8 5c 00 00    	pushl  0x5cf8
    3351:	e8 3a 06 00 00       	call   3990 <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    336b:	68 13 4c 00 00       	push   $0x4c13
    3370:	6a 01                	push   $0x1
    3372:	e8 19 06 00 00       	call   3990 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3408:	50                   	push   %eax
    3409:	68 20 4c 00 00       	push   $0x4c20
    340e:	6a 01                	push   $0x1
    3410:	e8 7b 05 00 00       	call   3990 <printf>
    ...
    3442:	68 e0 84 00 00       	push   $0x84e0
    3447:	57                   	push   %edi
    ...
    345a:	56                   	push   %esi
    345b:	68 3c 4c 00 00       	push   $0x4c3c
    3460:	6a 01                	push   $0x1
    3462:	e8 29 05 00 00       	call   3990 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3484:	50                   	push   %eax
    3485:	68 2c 4c 00 00       	push   $0x4c2c
    348a:	6a 01                	push   $0x1
    348c:	e8 ff 04 00 00       	call   3990 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3538:	68 4c 4c 00 00       	push   $0x4c4c
    353d:	6a 01                	push   $0x1
    353f:	e8 4c 04 00 00       	call   3990 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3556:	68 62 4c 00 00       	push   $0x4c62
    355b:	6a 01                	push   $0x1
    355d:	e8 2e 04 00 00       	call   3990 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    3578:	68 6c 4c 00 00       	push   $0x4c6c
    357d:	6a 01                	push   $0x1
    357f:	e8 0c 04 00 00       	call   3990 <printf>
}
  ...
  if(pid == 0){
    ...
    359a:	52                   	push   %edx
    359b:	52                   	push   %edx
    359c:	68 d4 53 00 00       	push   $0x53d4
    35a1:	6a 01                	push   $0x1
    35a3:	e8 e8 03 00 00       	call   3990 <printf>
    exit();
    ...
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    35af:	68 f1 4b 00 00       	push   $0x4bf1
    35b4:	6a 01                	push   $0x1
    35b6:	e8 d5 03 00 00       	call   3990 <printf>
    exit();
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    35c0:	69 05 f4 5c 00 00 0d 	imul   $0x19660d,0x5cf4,%eax
    35c7:	66 19 00 
}
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    ...
    35d3:	a3 f4 5c 00 00       	mov    %eax,0x5cf4
  return randstate;
}
    35d8:	c3                   	ret    
...
SYSCALL(sem_down)
    ...
    38df:	cd 40                	int    $0x40
    38e1:	c3                   	ret    
    38e2:	66 90                	xchg   %ax,%ax
    38e4:	66 90                	xchg   %ax,%ax
    38e6:	66 90                	xchg   %ax,%ax
    38e8:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(neg)
    ...
    3951:	8d 7c 0d d7          	lea    -0x29(%ebp,%ecx,1),%edi
    3955:	8d 76 00             	lea    0x0(%esi),%esi
    3958:	0f b6 07             	movzbl (%edi),%eax
#include "user.h"
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    395e:	83 ef 01             	sub    $0x1,%edi
    3961:	6a 01                	push   $0x1
    3963:	53                   	push   %ebx
    3964:	56                   	push   %esi
    3965:	88 45 d7             	mov    %al,-0x29(%ebp)
    3968:	e8 d5 fe ff ff       	call   3842 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    3970:	39 df                	cmp    %ebx,%edi
    3972:	75 e4                	jne    3958 <printint+0x68>
    putc(fd, buf[i]);
}
    3974:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3977:	5b                   	pop    %ebx
    3978:	5e                   	pop    %esi
    3979:	5f                   	pop    %edi
    397a:	5d                   	pop    %ebp
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    39d8:	50                   	push   %eax
    39d9:	57                   	push   %edi
    39da:	e8 63 fe ff ff       	call   3842 <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3a3a:	50                   	push   %eax
    3a3b:	57                   	push   %edi
    3a3c:	e8 01 fe ff ff       	call   3842 <write>
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3aa8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    3aab:	b8 24 54 00 00       	mov    $0x5424,%eax
    3ab0:	85 db                	test   %ebx,%ebx
    3ab2:	0f 44 d8             	cmove  %eax,%ebx
        while(*s != 0){
    3ab5:	0f b6 03             	movzbl (%ebx),%eax
    3ab8:	84 c0                	test   %al,%al
    3aba:	74 23                	je     3adf <printf+0x14f>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    3ace:	50                   	push   %eax
    3acf:	57                   	push   %edi
    3ad0:	e8 6d fd ff ff       	call   3842 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3b1f:	50                   	push   %eax
    3b20:	57                   	push   %edi
    3b21:	e8 1c fd ff ff       	call   3842 <write>
    3b26:	e9 5b ff ff ff       	jmp    3a86 <printf+0xf6>
    3b2b:	66 90                	xchg   %ax,%ax
    3b2d:	66 90                	xchg   %ax,%ax
    3b2f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b31:	a1 a0 5d 00 00       	mov    0x5da0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    3b40:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b43:	39 c8                	cmp    %ecx,%eax
    3b45:	73 19                	jae    3b60 <free+0x30>
    3b47:	89 f6                	mov    %esi,%esi
    3b49:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    3b50:	39 d1                	cmp    %edx,%ecx
    3b52:	72 1c                	jb     3b70 <free+0x40>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3b54:	39 d0                	cmp    %edx,%eax
    3b56:	73 18                	jae    3b70 <free+0x40>
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3b5e:	72 f0                	jb     3b50 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3b60:	39 d0                	cmp    %edx,%eax
    3b62:	72 f4                	jb     3b58 <free+0x28>
    3b64:	39 d1                	cmp    %edx,%ecx
    3b66:	73 f0                	jae    3b58 <free+0x28>
    3b68:	90                   	nop
    3b69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      break;
  if(bp + bp->s.size == p->s.ptr){
    3b70:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3b73:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3b76:	39 d7                	cmp    %edx,%edi
    3b78:	74 19                	je     3b93 <free+0x63>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3b7a:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3b7d:	8b 50 04             	mov    0x4(%eax),%edx
    3b80:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3b83:	39 f1                	cmp    %esi,%ecx
    3b85:	74 23                	je     3baa <free+0x7a>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3b87:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3b89:	a3 a0 5d 00 00       	mov    %eax,0x5da0
}
    3b8e:	5b                   	pop    %ebx
    3b8f:	5e                   	pop    %esi
    3b90:	5f                   	pop    %edi
  ...
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    3b93:	03 72 04             	add    0x4(%edx),%esi
    3b96:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3b99:	8b 10                	mov    (%eax),%edx
    3b9b:	8b 12                	mov    (%edx),%edx
    3b9d:	89 53 f8             	mov    %edx,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3ba0:	8b 50 04             	mov    0x4(%eax),%edx
    3ba3:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3ba6:	39 f1                	cmp    %esi,%ecx
    3ba8:	75 dd                	jne    3b87 <free+0x57>
    p->s.size += bp->s.size;
    3baa:	03 53 fc             	add    -0x4(%ebx),%edx
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  freep = p;
    3bad:	a3 a0 5d 00 00       	mov    %eax,0x5da0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp->s.ptr;
    3bb5:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3bb8:	89 10                	mov    %edx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3bcc:	8b 15 a0 5d 00 00    	mov    0x5da0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    ...
    3bdd:	0f 84 a3 00 00 00    	je     3c86 <malloc+0xc6>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3bea:	76 74                	jbe    3c60 <malloc+0xa0>
    3bec:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    3bf2:	be 00 10 00 00       	mov    $0x1000,%esi
    3bf7:	8d 1c fd 00 00 00 00 	lea    0x0(,%edi,8),%ebx
    3bfe:	0f 43 f7             	cmovae %edi,%esi
    3c01:	ba 00 80 00 00       	mov    $0x8000,%edx
    3c06:	81 ff ff 0f 00 00    	cmp    $0xfff,%edi
    3c0c:	0f 46 da             	cmovbe %edx,%ebx
    3c0f:	eb 10                	jmp    3c21 <malloc+0x61>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3c1f:	76 3f                	jbe    3c60 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    3c29:	75 ed                	jne    3c18 <malloc+0x58>
  char *p;
  Header *hp;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3c2e:	53                   	push   %ebx
    3c2f:	e8 76 fc ff ff       	call   38aa <sbrk>
  if(p == (char*)-1)
    3c34:	83 c4 10             	add    $0x10,%esp
    3c37:	83 f8 ff             	cmp    $0xffffffff,%eax
    3c3a:	74 1c                	je     3c58 <malloc+0x98>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3c3c:	89 70 04             	mov    %esi,0x4(%eax)
  free((void*)(hp + 1));
    3c3f:	83 ec 0c             	sub    $0xc,%esp
    3c42:	83 c0 08             	add    $0x8,%eax
    3c45:	50                   	push   %eax
    3c46:	e8 e5 fe ff ff       	call   3b30 <free>
  return freep;
    ...
    3c56:	75 c0                	jne    3c18 <malloc+0x58>
        return 0;
    3c58:	31 c0                	xor    %eax,%eax
    3c5a:	eb 1c                	jmp    3c78 <malloc+0xb8>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3c62:	74 1c                	je     3c80 <malloc+0xc0>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3c84:	eb e9                	jmp    3c6f <malloc+0xaf>
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    ...
    3ca6:	00 00 00 
    3ca9:	e9 3e ff ff ff       	jmp    3bec <malloc+0x2c>
