...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 e6 07 00 00       	mov    $0x7e6,%eax
